package br.com.examplejwt.cookie.config.jwt;
...
/**
 * Utilitário responsável por criar, obter, validar, converter informações do Token em conteúdo, ou conteúdo num cookie.
 * <br />
 * Utility responsible for creating, obtaining, validating, converting Token information into content, or content into a cookie
 *
 * @author Marcio
 */
@Component
public class JwtUtils {
    ...
    public boolean validateJwtToken(final String authToken) {
        try {
            ...
            LOGGER.error("JWT cookie is expired: {}", e.getMessage());
        } catch (UnsupportedJwtException e) {
            LOGGER.error("JWT cookie is unsupported: {}", e.getMessage());
