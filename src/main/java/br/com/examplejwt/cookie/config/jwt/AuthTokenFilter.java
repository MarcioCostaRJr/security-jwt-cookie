...
import br.com.examplejwt.cookie.service.impl.UserDetailsServiceImpl;
 ...
 * dos dados obtidos no cookie, se for satisfatória informa ao contexto de segurança do Spring. <br/>
 *
 * Performs pre-processing of HTTP requests through Token (jwt) to create authentication based on validation
 * of the data obtained in the cookie, if satisfactory informs the Spring cookie context.
 *
 * @author Marcio
 */
